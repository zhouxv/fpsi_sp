...
namespace secJoin {
    ...
    macoro::task<> AltModKeyMultReceiver::mult(u64 n, oc::Matrix<block> &xk0, oc::Matrix<block> &xk1, coproto::Socket &sock)
    {
        ...
        if (mDebug) {
            ...
            oc::Matrix<block> xk0b(xk0.rows(), xk0.cols()), xk1b(xk0.rows(), xk0.cols()), xk0_(xk0.rows(), xk0.cols()), xk1_(xk0.rows(), xk0.cols()),
                xLsb(xk0.rows(), xk0.cols()), xMsb(xk0.rows(), xk0.cols());
    ...
    macoro::task<> AltModKeyMultSender::mult(
        oc::MatrixView<const block> xLsb, oc::MatrixView<const block> xMsb, oc::Matrix<block> &xk0, oc::Matrix<block> &xk1, coproto::Socket &sock)
    {
            ...
            for (u64 k = 0; k < StepSize; ++i, ++k) {
                ...
                if (xMsb.size()) {
                    ...
                    if (keyShare) {
                        ...
                        mod3Sub(msbMsg, lsbMsg, msbShare, lsbShare, xMsb[i], xLsb[i]);

                        // xk = -G(OT(i,0)) + xt mod 3
                        mod3Add(xk1[i], xk0[i], xMsb[i], xLsb[i]);
                    } else {
                        // msg = G(OT(i,0)) + x mod 3
                        mod3Add(msbMsg, lsbMsg, msbShare, lsbShare, xMsb[i], xLsb[i]);
                    ...
                    if (keyShare) {
                        // msg = G(OT(i,0)) - x mod 3
                        mod3Sub(msbMsg, lsbMsg, msbShare, lsbShare, xLsb[i]);

                        // xk = -G(OT(i,0)) + xt mod 3
                        mod3Add(xk1[i], xk0[i], xLsb[i]);
                    } else {
                        // msg = G(OT(i,0)) + x mod 3
                        mod3Add(msbMsg, lsbMsg, msbShare, lsbShare, xLsb[i]);
