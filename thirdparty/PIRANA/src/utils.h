...
public:
    ...
    inline double elapsed()
    {
        ...
        return std::chrono::duration_cast<std::chrono::microseconds>(_end - _start).count() / 1000.0;
    }
...
std::vector<uint32_t> get_perfect_constant_weight_codeword(uint64_t number, uint64_t encoding_size, uint64_t hamming_weight = 2);
