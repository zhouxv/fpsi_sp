...
private:
    ...
    void get_all_index_hash_result(const uint64_t num_payloads, const uint64_t num_query, const double cuckoo_factor = 1.5);
...
public:
    ...
    void set_seal_parms(uint64_t poly_degree = 4096, std::vector<int> coeff_modulus = { 48, 32, 24 }, uint64_t prime_len = 18);
    inline seal::EncryptionParameters get_seal_parms()
    {
        return _seal_parms;
    };

    inline uint64_t get_num_payloads()
    {
        return _num_payloads;
    }
    inline uint64_t get_payload_size()
    {
        return _payload_size;
    }
    inline uint64_t get_col_size()
    {
        return _col_size;
    }
    inline uint64_t get_num_payload_slot()
    {
        return _num_payload_slot;
    };
    inline uint64_t get_hamming_weight()
    {
        return _hamming_weight;
    };
    inline uint64_t get_encoding_size()
    {
        return _encoding_size;
    };
    inline uint64_t get_rotate_step()
    {
        return _rotate_step;
    };
    inline uint64_t get_pre_rotate()
    {
        return _pre_rotate;
    };

    // using only in Batch PIR
    inline uint64_t get_num_query()
    {
        return _num_query;
    };
    ...
    inline uint32_t get_num_slot()
    {
        return _num_slot;
    };
    inline uint32_t get_bundle_size()
    {
        return _bundle_size;
    };
    inline uint32_t get_batch_pir_num_compress_slot()
    {
        return _is_compress ? std::ceil(static_cast<double>(_num_payload_slot) / _num_slot) : _num_payload_slot;
    };
    inline bool get_is_compress()
    {
        return _is_compress;
    };
    inline std::shared_ptr<kuku::KukuTable> get_cuckoo_table()
    {
        return _table;
    };
    ...
    inline std::vector<std::vector<uint32_t>> &get_bucket()
    {
        return _bucket;
    };
